...
/**
 * The mod_opendsa_activity group override deleted event.
 *
...
/**
 * The mod_opendsa_activity group override deleted event class.
 *
...
class group_override_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridedeleted', 'mod_opendsa_activity');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the override with id '$this->objectid' for the opendsa_activity with " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/opendsa_activity/overrides.php', array('cmid' => $this->contextinstanceid));
    }
