...
/**
 * The mod_opendsa_activity opendsa_activity restarted event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class opendsa_activity_restarted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventopendsa_activityrestarted', 'mod_opendsa_activity');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' abandoned their previous incomplete attempt ".
               "and started a new attempt on the opendsa_activity with course module id '$this->contextinstanceid'.";
    }
