...
switch ($action) {
    case 'confirmdelete':
        ...
        $params = array("opendsa_activity_id" => $lesson->id, "pageid" => $pageid);
        if ($answers = $DB->get_records_select("lesson_answers", "opendsa_activity_id = :opendsa_activity_id AND jumpto = :pageid + 1", $params)) {
