@mod @mod_opendsa_activity @_file_upload
Feature: In a opendsa_activity activity, teacher can add an essay question
  As a teacher
  I need to add an essay question in a opendsa_activity and grade student attempts
  ...
  Scenario: questions with essay question
    ...
    And I should see "Student 1"
    And I click on ".opendsa_activity-attempt-link" "css_element" in the "Student 1" "table_row"
