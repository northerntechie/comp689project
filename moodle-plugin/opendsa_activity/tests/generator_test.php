...
class mod_lesson_generator_testcase extends advanced_testcase {
    ...
    public function test_create_content() {
        ...
        $records = $DB->get_records('lesson_pages', array('opendsa_activity_id' => $lesson->id), 'id');
        $this->assertEquals(2, count($records));
    ...
    public function test_create_question_truefalse() {
        ...
        $records = $DB->get_records('lesson_pages', array('opendsa_activity_id' => $lesson->id), 'id');
        $p1answers = $DB->get_records('lesson_answers', array('opendsa_activity_id' => $lesson->id, 'pageid' => $page1->id), 'id');
        $p2answers = $DB->get_records('lesson_answers', array('opendsa_activity_id' => $lesson->id, 'pageid' => $page2->id), 'id');
