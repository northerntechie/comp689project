...
Feature: Include responses from inactive users
  In order to view responses from inactive or suspended users in opendsa results
  As a teacher
  I need to enable the opendsa include inactive option
  ...
  Scenario: Enable the opendsa include inactive option and check that responses from inactive students are visible
    ...
    And I am on "Course 1" course homepage
    And I choose "Option 2" from "OpenDSA name" opendsa activity
    And I log out
    And I log in as "student3"
    And I am on "Course 1" course homepage
    And I choose "Option 3" from "OpenDSA name" opendsa activity
    And I log out
    And the following "course enrolments" exist:
  ...
  Scenario: Disable the opendsa include inactive option and check that responses from inactive students are not visible
    Given I add a "OpenDSA" to section "1" and I fill the form with:
      | OpenDSA name | OpenDSA name |
      | Description | OpenDSA Description |
      | option[0] | Option 1 |
