@mod @mod_opendsa
Feature: Restrict availability of the opendsa module to a deadline
  ...
  Scenario: Enable the opendsa activity with a start deadline in the future
  ...
  Scenario: Enable the opendsa activity with a start deadline in the past
    Given I add a "OpenDSA" to section "1" and I fill the form with:
      | OpenDSA name | OpenDSA name |
      | Description | OpenDSA Description |
      | option[0] | Option 1 |
    ...
    And I am on "Course 1" course homepage
    And I follow "OpenDSA name"
    And "opendsa_1" "radio" should exist
    And "opendsa_2" "radio" should exist
    And "Save my opendsa" "button" should exist

  Scenario: Enable the opendsa activity with a end deadline in the future
    Given I add a "OpenDSA" to section "1" and I fill the form with:
      | OpenDSA name | OpenDSA name |
      | Description | OpenDSA Description |
      | option[0] | Option 1 |
  ...
  Scenario: Enable the opendsa activity with a end deadline in the past
    Given I add a "OpenDSA" to section "1" and I fill the form with:
      | OpenDSA name | OpenDSA name |
      | Description | OpenDSA Description |
      | option[0] | Option 1 |
