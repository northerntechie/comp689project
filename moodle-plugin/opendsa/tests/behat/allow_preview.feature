@mod @mod_opendsa
Feature: Allow opendsa preview
  In order to allow students to preview options before a opendsa activity is opened for submission
  As a teacher
  I need to enable the opendsa preview option
  ...
  Scenario: Enable the opendsa preview option and view the activity as a student before the opening time
    ...
    And the "opendsa_2" "radio" should be disabled
