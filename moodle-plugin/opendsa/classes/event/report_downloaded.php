 ...
 *      - int opendsad: The id of the opendsa
 * }
 *
 * @package    mod_opendsa
 * @since      Moodle 3.1
...
class report_downloaded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportdownloaded', 'mod_opendsa');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has downloaded the report in the '".$this->other['format']."' format for
            the opendsa activity with course module id '$this->contextinstanceid'";
    }
