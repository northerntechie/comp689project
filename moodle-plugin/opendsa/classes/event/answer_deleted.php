...
/**
 * The mod_opendsa answer deleted event.
 *
 * @package    mod_opendsa
...
/**
 * The mod_opendsa answer deleted event class.
 *
...
class answer_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventanswerdeleted', 'mod_opendsa');
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'opendsa_answers', 'restore' => \core\event\base::NOT_MAPPED);
    }
